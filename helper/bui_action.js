...
bui.Action.prototype = {
    ...
    enterAction : function(args){
        ...
        que.push(function(next){var me = this;
            ...
            if (!me.main){
                me.main = bui.mainId;
                if (!bui.dom.getElementById(bui.mainId)) {
                    var mainElem = bui.dom.createElement('DIV');
                    me.main = bui.Action.makeGUID();
                    mainElem.id = me.main;
                    bui.dom.documentElement.appendChild(mainElem);
                }
            }
        ...
        que.push(function(next){var me = this;
            ...
            if (me.main){
                mainHTML = me.getView();
                mainHTML = bui.Action.getExtClass('bui.Template').merge(mainHTML, me.model.getData());
...
bui.Action.get = function(id){
    ...
    for (var i in map) {
        ...
        if (v && v.main && v.getMain().id == bui.mainId) {
            cur = map[i];
        }
    }
