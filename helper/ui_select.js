...
bui.Select.prototype = {
    ...
    setOptions: function (options) {
        var me = this;
        for (var i=me.getMain().childNodes.length-1; i>-1; i--) {
            me.getMain().removeChild(me.getMain().childNodes[i]);
        }
    ...
    setValue: function (v) {
        ...
        me.value = typeof v == 'string' ? v : v[dataValue];
